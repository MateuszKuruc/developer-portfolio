    ...
    <>
      <div className="padding-container regular-18 border-b-2 border-t-2 py-8">
        ...
        <div className="flex flex-col md:flex-row py-8">
          <div className="md:w-[50%]">
            <p>
              ...
              opted for Next.js framework as the main tool. The first reason is
              that the application is not backend-heavy, I just needed simple
              requests for handling contact form for clients. The second reason
              is that Next provides firm project structure which is very
              intuitive and provides pleasant developer experience.
            </p>
            <p className="py-4">
        ...
        <div className="flex flex-col-reverse md:flex-row py-8 items-center">
          ...
          <div className="md:w-[50%]">
            ...
            <p className="py-4">
              ...
              most popular tool for creating cohesive animations throughout the
              project.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row py-8">
          <div className="md:w-[50%]">
            <p>
              The heart of the website is the <strong>contact form</strong>, so
              I needed to execute it well and provide{" "}
              <strong>clear guidance </strong>to the user who interacts with it.
              My tool of choice was <strong>Formik </strong>library, which makes
              form state management and form validation easier, while still
              allowing customization.
            </p>
            <p className="py-4">
              <strong>Yup </strong>works great with Formik for validation
              purposes and displaying errors, so I decided to pair them.
              Additionally, I used <strong>Nodemailer </strong>on the backend to
              handle contact form data and <strong>automatically </strong> send
              an email to the website owner whenever the client uses contact
              form.
            </p>
          </div>
